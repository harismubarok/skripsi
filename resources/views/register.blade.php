...
<body>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('images/kampus.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Masukan No.Hp">
                        <input class="input100" type="text" name="hp" placeholder="No Hp">
                        <span class="focus-input100" data-placeholder="&#xf10b;"></span>
                    </div>
                    ...
                    <div class="container-login10 m-t-32">
